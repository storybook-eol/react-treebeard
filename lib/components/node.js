...
var TreeNode = function (_Component) {
    ...
    _createClass(TreeNode, [{
        ...
        key: 'renderChildren',
        value: function renderChildren(decs, animations) {
            var _this2 = this;

            var _props3 = this.props;
            var decoratorProps = _props3.decoratorProps;
            var node = _props3.node;
            var style = _props3.style;

            if (this.props.node.loading) {
                return this.renderLoading(decs, decoratorProps);
            }
        ...
        key: 'renderLoading',
        value: function renderLoading(decorators, decoratorProps) {
            return React.createElement(
                'ul',
                ...
                React.createElement(
                    'li',
                    null,
                    React.createElement(decorators.Loading, _extends({ style: this.props.style.loading }, decoratorProps))
                )
            );
        }
    }, {
